...
public static class Modules
{
    ...
    {
        return new Vector2(vector.X * Globals.Instance.GRID_SIZE, vector.Y * Globals.Instance.GRID_SIZE);
    }

    public static Vector2I ConvertToVector2I(Vector2 vector)
    {
        return new Vector2I((int)vector.X / Globals.Instance.GRID_SIZE, (int)vector.Y / Globals.Instance.GRID_SIZE);
    }
}